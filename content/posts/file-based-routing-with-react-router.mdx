...
I'll be updating Render to **enable per page lazy loading and code splitting with Vite**, I'm planning to write about that in a future post. I got pre-rendering and file-based routing working together with Vite. And server-side rendering should work as well with very few additions.

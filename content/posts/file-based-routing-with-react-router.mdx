---
title: File-based routing with React Router - 1
...
image: /images/tags/react-router-next-react-vite.png
...
I'll be updating Render to **enable automatic route-based code-splitting and lazy-loading with Vite**, I'm planning to write about that in a future post. I got pre-rendering and file-based routing working together with Vite. And server-side rendering should work as well with very few additions.

---
title: File-based routing with React Router - 2
...
In the next post we'll talk about **routes pre-loading**. It will allow us to pre-load a route based on an event, like when the user views the route link or hovers over it.
